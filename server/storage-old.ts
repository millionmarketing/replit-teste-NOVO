...
export interface IStorage {
  ...
  updateMetrics(userId: string, metrics: InsertMetrics): Promise<Metrics>;

  // WhatsApp Settings (with user isolation)
  getWhatsappSettings(userId: string): Promise<WhatsappSettings | undefined>;
  updateWhatsappSettings(userId: string, settings: InsertWhatsappSettings): Promise<WhatsappSettings>;
}
